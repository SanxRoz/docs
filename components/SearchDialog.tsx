...
import { X, Loader, User, Frown, CornerDownLeft, Wand2 } from 'lucide-react'
  ...
  return (
    <>
      <button
        ...
        className="text-base flex gap-3 items-center px-4 py-2 z-50 relative bg-[#262629]
        text-[#eee] dark:text-[#eee] hover:text-[#eee] dark:hover:text-[#eee]
        transition-colors
        rounded-full
        border border-[#ffffff14] dark:border-[#ffffff14] hover:border-[#ffffff30] dark:hover:border-slate-500
        min-w-[300px] "
      >
        <Wand2 width={20} />
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] text-black">
          <DialogHeader>
            <DialogTitle>Find faster a better</DialogTitle>
